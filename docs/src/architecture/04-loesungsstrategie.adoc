...
* link:../adrs/ADR-013-react-typescript-frontend.md[React 18 + TypeScript] - Typsicherheit, moderne Hooks
* link:../adrs/ADR-001-vite-build-tool.md[Vite] - Schneller Build, optimiertes Bundling
* link:../adrs/ADR-017-tailwindcss-styling.md[TailwindCSS] - Utility-First CSS, responsive Design
* link:../adrs/ADR-002-react-router.md[React Router] - Client-seitiges Routing
* link:../adrs/ADR-003-tanstack-query.md[TanStack Query] - Server State Management, Caching
* link:../adrs/ADR-004-zustand-state-management.md[Zustand] - Lokales State Management
* link:../adrs/ADR-016-pwa-architecture.md[Workbox] - Service Worker für PWA

==== Backend

*Siehe ADRs für Details:*

* link:../adrs/ADR-014-python-fastapi-backend.md[Python 3.11+ + FastAPI] - Moderne Sprache, Async-fähig
* link:../adrs/ADR-005-pydantic-validation.md[Pydantic] - Datenvalidierung und Serialisierung
* link:../adrs/ADR-006-sqlalchemy-orm.md[SQLAlchemy 2.0] - ORM mit Typsicherheit
* link:../adrs/ADR-007-alembic-migrations.md[Alembic] - Datenbank-Migrationen

==== Datenbank & Infrastruktur

* link:../adrs/ADR-015-turso-database.md[Turso (libSQL)] - Edge-Database mit Sync
* SQLite - Lokal für Entwicklung und Offline-Betrieb
* link:../adrs/ADR-011-docker-development.md[Docker] - Containerisierung für Deployment
...
Siehe auch: link:../adrs/ADR-008-monorepo-structure.md[ADR-008: Monorepo-Struktur]
...
Siehe auch: link:../adrs/ADR-016-pwa-architecture.md[ADR-016: PWA-Architektur]
...
Siehe: link:../adrs/ADR-018-domain-driven-design.md[ADR-018: Domain-Driven Design]
