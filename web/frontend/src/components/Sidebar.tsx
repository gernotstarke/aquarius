...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-neutral-200 min-h-screen flex-shrink-0">
      ...
      {/* Impressum Link at Bottom */}
      <div className="px-3 pb-6 mt-auto">
        <Link
          to="/impressum"
          className="block px-3 py-2 text-xs text-neutral-500 hover:text-neutral-700 hover:bg-neutral-100 rounded-lg transition-colors text-center"
        >
          Impressum
        </Link>
      </div>
