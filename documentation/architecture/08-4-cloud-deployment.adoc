...
|Container-Platform
|**fly.io**
|• Einfaches Deployment mit `flyctl`
• Automatisches HTTPS/TLS
• Integriertes Load Balancing
• Globale Edge-Locations
• Kostenlose Tier für kleine Apps

|Datenbank
|**Turso (libSQL)**
|• Managed SQLite-as-a-Service
• SQLAlchemy-kompatibel über libSQL-Treiber
• Edge-Replication für niedrige Latenz
• Automatische Backups
• Kostenlose Tier (500 MB, 1 Mrd. Row Reads/Monat)

|Application Server
|**uvicorn**
|• ASGI-Server für FastAPI
• Hohe Performance
• WebSocket-Support

|Static File Serving
|**FastAPI StaticFiles**
|• Direkt aus Container
• Alternative: fly.io Volumes für größere Mengen
